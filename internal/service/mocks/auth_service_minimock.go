...
//go:generate minimock -i github.com/PerfilievAlexandr/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
type AuthServiceMock struct {
	...
	funcGetAccessToken          func(ctx context.Context, req string) (s1 string, err error)
	inspectFuncGetAccessToken   func(ctx context.Context, req string)
	afterGetAccessTokenCounter  uint64
	beforeGetAccessTokenCounter uint64
	GetAccessTokenMock          mAuthServiceMockGetAccessToken

	funcGetRefreshToken          func(ctx context.Context, req string) (s1 string, err error)
	inspectFuncGetRefreshToken   func(ctx context.Context, req string)
	afterGetRefreshTokenCounter  uint64
	beforeGetRefreshTokenCounter uint64
	GetRefreshTokenMock          mAuthServiceMockGetRefreshToken

	funcLogin          func(ctx context.Context, req authGrpcDto.LoginRequest) (s1 string, err error)
	inspectFuncLogin   func(ctx context.Context, req authGrpcDto.LoginRequest)
...
func (mmGetAccessToken *mAuthServiceMockGetAccessToken) Expect(ctx context.Context, req string) *mAuthServiceMockGetAccessToken {
	...
	mmGetAccessToken.defaultExpectation.params = &AuthServiceMockGetAccessTokenParams{ctx, req}
...
func (mmGetAccessToken *mAuthServiceMockGetAccessToken) Inspect(f func(ctx context.Context, req string)) *mAuthServiceMockGetAccessToken {
...
func (mmGetAccessToken *mAuthServiceMockGetAccessToken) Set(f func(ctx context.Context, req string) (s1 string, err error)) *AuthServiceMock {
	if mmGetAccessToken.defaultExpectation != nil {
...
// Then helper
func (mmGetAccessToken *mAuthServiceMockGetAccessToken) When(ctx context.Context, req string) *AuthServiceMockGetAccessTokenExpectation {
	if mmGetAccessToken.mock.funcGetAccessToken != nil {
		mmGetAccessToken.mock.t.Fatalf("AuthServiceMock.GetAccessToken mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockGetAccessTokenExpectation{
		...
		params: &AuthServiceMockGetAccessTokenParams{ctx, req},
	}
...
func (mmGetAccessToken *AuthServiceMock) GetAccessToken(ctx context.Context, req string) (s1 string, err error) {
	...
	mm_params := AuthServiceMockGetAccessTokenParams{ctx, req}
	...
	if mmGetAccessToken.GetAccessTokenMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockGetAccessTokenParams{ctx, req}
	...
	mmGetAccessToken.t.Fatalf("Unexpected call to AuthServiceMock.GetAccessToken. %v %v", ctx, req)
	return
}
...
func (mmGetRefreshToken *mAuthServiceMockGetRefreshToken) Expect(ctx context.Context, req string) *mAuthServiceMockGetRefreshToken {
	...
	mmGetRefreshToken.defaultExpectation.params = &AuthServiceMockGetRefreshTokenParams{ctx, req}
...
func (mmGetRefreshToken *mAuthServiceMockGetRefreshToken) Inspect(f func(ctx context.Context, req string)) *mAuthServiceMockGetRefreshToken {
...
func (mmGetRefreshToken *mAuthServiceMockGetRefreshToken) Set(f func(ctx context.Context, req string) (s1 string, err error)) *AuthServiceMock {
	if mmGetRefreshToken.defaultExpectation != nil {
...
// Then helper
func (mmGetRefreshToken *mAuthServiceMockGetRefreshToken) When(ctx context.Context, req string) *AuthServiceMockGetRefreshTokenExpectation {
	if mmGetRefreshToken.mock.funcGetRefreshToken != nil {
		mmGetRefreshToken.mock.t.Fatalf("AuthServiceMock.GetRefreshToken mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockGetRefreshTokenExpectation{
		...
		params: &AuthServiceMockGetRefreshTokenParams{ctx, req},
	}
...
func (mmGetRefreshToken *AuthServiceMock) GetRefreshToken(ctx context.Context, req string) (s1 string, err error) {
	...
	mm_params := AuthServiceMockGetRefreshTokenParams{ctx, req}
	...
	if mmGetRefreshToken.GetRefreshTokenMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockGetRefreshTokenParams{ctx, req}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetRefreshToken.t.Fatalf("Unexpected call to AuthServiceMock.GetRefreshToken. %v %v", ctx, req)
	return
}
...
func (mmLogin *mAuthServiceMockLogin) Expect(ctx context.Context, req authGrpcDto.LoginRequest) *mAuthServiceMockLogin {
...
func (mmLogin *mAuthServiceMockLogin) Inspect(f func(ctx context.Context, req authGrpcDto.LoginRequest)) *mAuthServiceMockLogin {
...
func (mmLogin *mAuthServiceMockLogin) Set(f func(ctx context.Context, req authGrpcDto.LoginRequest) (s1 string, err error)) *AuthServiceMock {
	if mmLogin.defaultExpectation != nil {
...
// Then helper
func (mmLogin *mAuthServiceMockLogin) When(ctx context.Context, req authGrpcDto.LoginRequest) *AuthServiceMockLoginExpectation {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("AuthServiceMock.Login mock is already set by Set")
	}
...
func (mmLogin *AuthServiceMock) Login(ctx context.Context, req authGrpcDto.LoginRequest) (s1 string, err error) {
