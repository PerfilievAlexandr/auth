...
type UserServiceMock struct {
	...
	funcGet          func(ctx context.Context, id int64) (up1 *domain.User, err error)
...
func (mmDelete *UserServiceMock) Delete(ctx context.Context, id int64) (ep1 *emptypb.Empty, err error) {
...
func (mmGet *mUserServiceMockGet) Return(up1 *domain.User, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id int64) (up1 *domain.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(up1 *domain.User, err error) *UserServiceMock {
	e.results = &UserServiceMockGetResults{up1, err}
	return e.mock
}

// Get implements service.UserService
func (mmGet *UserServiceMock) Get(ctx context.Context, id int64) (up1 *domain.User, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Return(ep1 *emptypb.Empty, err error) *UserServiceMock {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (e *UserServiceMockUpdateExpectation) Then(ep1 *emptypb.Empty, err error) *UserServiceMock {
